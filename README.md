...
!!! note Checklist
    - [ ] Create an empty repository (namely, `https://github.com/okatsn/EventSpaceAlgebra.jl.git`) on github, and push the local to origin. See [connecting to remote](#tips-for-connecting-to-remote).
...
### Auto-Registration
- You have to add `ACCESS_OKREGISTRY` to the secret under the remote repo (e.g., https://github.com/okatsn/EventSpaceAlgebra.jl).
...
Connect to remote:
1. Switch to the local directory of this project (EventSpaceAlgebra)
2. Add an empty repo EventSpaceAlgebra(.jl) on github (without anything!)
