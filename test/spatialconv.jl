@testset "spatialconv.jl" begin
    ...
    @test isequal(EventTimeJD(0), uconvert(jd, EventTime(-EventSpaceAlgebra.epoch_julian_diff_ms * u"ms_epoch"))) # FIXME: You should also revise all the uconvert.jl stuffs.
end
